...
\begin{enumerate}
  \item What is a scalar-valued function of a scalar variable $f:\mathbb{R} \to \mathbb{R}$?
  \item What is a scalar-valued function of several variables? What is a scalar-valued function of a vector variable $f:\mathbb{R}_n \to \mathbb{R}$?
  \item What is a vector-valued function of one variable? What is a vector-valued function of a scalar variable $f:\mathbb{R} \to \mathbb{R}_n$?
  \item What is a vector-valued function of several variables? What is a vector-valued function of a vector variable $f:\mathbb{R}_n \to \mathbb{R}_m$?
...
\begin{enumerate}[resume]
  ...
  \item State the differentiation rules (sum, scalar multiplication, dot product, cross product).
    \begin{enumerate}
      \item What is the derivative of the sum of two vector-valued functions $\mathbf{r}(t)$ and $\mathbf{s}(t)$?
        \[
          \frac{d}{dt}\big(\mathbf{r}(t) + \mathbf{s}(t)\big)\,?
        \]
      \item What is the derivative of a scalar function $f(t)$ times a vector-valued function $\mathbf{r}(t)$?
        \[
          \frac{d}{dt}\big(f(t)\,\mathbf{r}(t)\big)\,?
        \]
      \item What is the derivative of the dot product of two vector-valued functions $\mathbf{r}(t)$ and $\mathbf{s}(t)$?
        \[
          \frac{d}{dt}\big(\mathbf{r}(t)\cdot \mathbf{s}(t)\big)\,?
        \]
      \item What is the derivative of the cross product of two vector-valued functions $\mathbf{r}(t)$ and $\mathbf{s}(t)$?
        \[
          \frac{d}{dt}\big(\mathbf{r}(t)\times \mathbf{s}(t)\big)\,?
        \]
    \end{enumerate}
...
\begin{enumerate}[resume]
  \item What is the gradient $\nabla f$? Give its type (domain, codomain) and notation.
