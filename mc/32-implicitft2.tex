\section{Implicit Function Theorem (2)}
...
\begin{enumerate}
  ...
  \item In the IFT, why is it necessary to require that the partial Jacobian $D_y F(a,b)$ is invertible (i.e.\ $\det D_y F(a,b) \neq 0$)? What can go wrong if this condition fails? Provide a concrete example.
  \item The IFT guarantees a function $g : U \to V$ such that $F(x, g(x)) = 0$ for all $x \in U$. What are $U$ and $V$? In what sense is $g$ unique?
...
\begin{enumerate}[resume]
  ...
  \item Let $F : \mathbb{R}^2 \times \mathbb{R}^2 \to \mathbb{R}^2$ be defined by
    \[
      F(x_1, x_2, y_1, y_2) =
      \begin{pmatrix} x_1^2 - y_1 + y_2 \\ x_2 + y_1 y_2 - 1
      \end{pmatrix}.
    \]
