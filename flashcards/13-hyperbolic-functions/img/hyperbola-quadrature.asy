// The quadrature of the hyperbola: the area under y=1/x from 1 to x
// equals ln x. This is the classical picture behind calling ln the
...
// shaded region under the curve, from 1 to x0
